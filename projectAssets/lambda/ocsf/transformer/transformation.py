# This function was based on the work at https://github.com/aws-samples/amazon-security-lake-transformation-library/tree/main/transformation-function
import boto3
import base64
import json
import gzip
...
mapping_config = open(f"transforms/{MAPPING}")
